...
public class Atleta
{
	...
	/**
	 * El nombre del atleta. Se asume que los nombres de los atletas no estan
	 * repetidos, pero eso no es un problema para los atletas.
	 */
	private String nombre;

	/**
	 * El genero del atleta, basado en la enumeracion Genero
	 */
	...
	/**
	 * El pais al que representa el atleta
	 */
	private Pais pais;
	...
	/**
	 * Construye un nuevo atleta e inicializa sus atributos con la informacion de
	 * los parametros. La lista de participaciones se inicializa como una lista
	 * vacía.
	 * 
	 * @param elNombre El nombre del atleta.
	 * @param elGenero El genero del atleta.
	 * @param elPais   El pais al que representa el atleta. No es responsabilidad
	 *                 del atleta agregarse al pais.
	 */
