...
/**
 * Esta es la clase que es capaz de calcular estadisticas sobre los juegos
 * olimpicos. Para calcular las estadisticas, esta clase agrupa la informacion
 * sobre los atletas, paises y eventos, pero no tiene informacion sobre las
...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Una lista con todos los atletas. En esta lista los atletas no estan
	 * repetidos.
	 */
	private List<Atleta> atletas;

	/**
	 * Una lista con todos los paises para los cuales hay al menos un atleta.
	 */
	private List<Pais> paises;

	/**
	 * Una lista con los eventos registrados. En esta lista puede aparecer dos veces
	 * el mismo deporte pero solo si corresponde a anos diferentes.
	 */
	 ...
	 * @param paises  Un mapa con los paises, donde las llaves son los nombres de
	 *                los paises y los valores son los paises.
	...
	// ************************************************************************
	/**
	 * Retorna el pais que un atleta representa
	 */
	public String getPais(String nombreAtleta)
	{
	 ...
	 * 
	 * @param nombrePais El nombre del pais de interes.
	 ...
	 *         atleta.
	 * 
	 *         Si no se encuentra el pais con el nombre indicado, se retorna null.
	 */
